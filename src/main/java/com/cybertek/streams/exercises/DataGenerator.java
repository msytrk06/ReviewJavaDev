...
public class DataGenerator {
    ...
    public static Project project4 = new Project(4, LocalDateTime.now(), 1, LocalDateTime.now().plusHours(6), 1,
            "PRJ004", "Ticketing Application", manager1, LocalDate.now(), LocalDate.now().plusDays(2), Status.UAT_TEST,
